...
addpath(genpath('/Users/ehalewood/Desktop/BIOSSCOPE_working/MATLAB_code/mfiles')); %This is Ellie's laptop

%% update the folder information before getting started
%all path information will begin with the rootdir
rootdir = '/Users/ehalewood/Desktop/BIOSSCOPE_working';

%use the workdir to temporarily hold your CTD data
workdir = fullfile(rootdir,'CTD_from_BATS');

%use the CSVoutdir as a place to export your CSV file at the end
CSVoutdir = '/Users/ehalewood/Desktop/BIOSSCOPE_working/holdingZone';

%Bfile is the name of the bottle file you downloaded from the Google Drive
Bfile = fullfile(rootdir,'BATS_BS_COMBINED_MASTER_latest.xlsx');
