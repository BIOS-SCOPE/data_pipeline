---
title: "BATS_sampling_bacterial"
author: "Krista Longnecker"
date: "`28 May 2026`"
output: html_notebook
---

Modify to read in all BATS sampling logs as there are samples outside the BIOS-SCOPE casts that we need
...
#Rachel's bacterial is not always collected on the core casts, so for her we need all sheets
...
write_xlsx(df_counts,'../RawData/counts_bacterial.xlsx')
write_xlsx(df,'../RawData/BIOSSCOPE_BATSsamples_to2024_bacterial.xlsx')
